...
```{r}
cat("title=", "Alle Meldungen seit dem 2. August 2024.")
...
Zuletzt aktualisiert: `r format(time_current, "%d.%m.%Y, %H:%M")` Uhr. Gefördert von [un:box cologne](https://www.stadt-koeln.de/leben-in-koeln/unbox-cologne/index.html). [Hintergrund](https://meldeeimer.de/huerth) - [Impressum](https://meldeeimer.de/impressum) - [Datenschutz](https://meldeeimer.de/datenschutz)
:::
