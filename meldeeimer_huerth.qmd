...
# keep only reports indicating that bin is full
reports <- subset(reports, response == "Ja, dieser Mülleimer ist voll.")
...
# print table
DT::datatable(
  reports[, c("date", "hour", "time", "bin_id", "location")],
  escape = FALSE,
  colnames = c("Datum", "Stunde", "Uhrzeit", "Mülleimer", "Standort"),
  rownames = FALSE,
  filter = "top",
  extensions = 'Buttons',
  options = list(
